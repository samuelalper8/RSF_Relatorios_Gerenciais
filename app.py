...
try:
    ...
    # Aplica patches de qualidade automaticamente (sem alterar o módulo original)
    try:
        from restricoes_patches import patch_analisar_restricoes
        patch_analisar_restricoes()
    except Exception:
        pass  # patches são opcionais — módulo funciona sem eles
